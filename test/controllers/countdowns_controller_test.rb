...
class CountdownsControllerTest < ActionController::TestCase
  ...
  test "should create countdown" do
    assert_difference('Countdown.count') do
      post :create, countdown: { description: @countdown.description, image: @countdown.image, link: @countdown.link, time: @countdown.time, title: @countdown.title }
    end
  ...
  test "should update countdown" do
    patch :update, id: @countdown, countdown: { description: @countdown.description, image: @countdown.image, link: @countdown.link, time: @countdown.time, title: @countdown.title }
    assert_redirected_to countdown_path(assigns(:countdown))
  end
